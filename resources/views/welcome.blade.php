...
@section('content')
<main>
<section class="relative min-h-[480px] sm:min-h-[540px] md:min-h-[600px] flex items-center overflow-hidden bg-primary py-12 sm:py-16">
...
<div class="relative">
<div class="hidden sm:block absolute -left-4 sm:-left-8 -top-4 sm:-top-8 w-16 sm:w-24 h-16 sm:h-24 border-l-4 sm:border-l-8 border-t-4 sm:border-t-8 border-slate-400 opacity-50"></div>
...
<p class="text-base sm:text-lg text-slate-200 font-light mb-8 sm:mb-10 max-w-lg">
...
<a href="tel:+14692888881" class="inline-flex w-full sm:w-auto items-center justify-center bg-on-primary-container text-primary px-6 sm:px-8 py-3 rounded font-headline font-bold text-sm sm:text-lg hover:brightness-110 transition-all text-center">
                            Call Us Today For a Free Quote
                        </a>
<button type="button" class="w-full sm:w-auto border border-white/30 text-white px-6 sm:px-8 py-3 rounded font-headline font-bold text-sm sm:text-lg hover:bg-white/10 transition-all" onclick="document.getElementById('servicios')?.scrollIntoView({behavior:'smooth'})">
                            Our Models
                        </button>
</div>
</div>
...
<h2 class="text-4xl sm:text-5xl md:text-6xl lg:text-8xl font-headline font-black text-white uppercase mb-0 tracking-tight leading-none">
                        Services
                    </h2>
<p class="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-headline font-bold text-[#87A0CD] -mt-1 sm:-mt-2">
                        you need
                    </p>
</div>
...
<h3 class="text-primary font-headline font-bold text-lg sm:text-xl mb-4 leading-tight">
...
<h2 class="text-primary font-headline font-black text-3xl sm:text-4xl md:text-5xl leading-none uppercase">Our</h2>
<h3 class="text-white font-headline font-black text-4xl sm:text-5xl md:text-6xl lg:text-8xl leading-none uppercase -mt-1 sm:-mt-2">Work</h3>
...
<div class="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 items-center bg-[#1B365D] rounded-2xl sm:rounded-[2rem] lg:rounded-[3rem] p-4 sm:p-6 lg:p-8">
...
<div>
<div class="text-white font-headline font-black text-4xl sm:text-5xl leading-tight">10+</div>
<div class="text-[#87A0CD] font-headline font-bold text-xl uppercase tracking-wider">Years of experience</div>
</div>
<div>
<div class="text-white font-headline font-black text-4xl sm:text-5xl leading-tight">100+</div>
...
<div class="max-w-screen-2xl mx-auto">
<div class="text-center mb-10 sm:mb-16">
<h2 class="text-[#87A0CD] font-headline font-black text-3xl sm:text-4xl md:text-5xl leading-none uppercase">Our</h2>
<h3 class="text-primary font-headline font-black text-4xl sm:text-5xl md:text-6xl lg:text-8xl leading-none uppercase -mt-1 sm:-mt-2">Experience</h3>
</div>
...
<h2 class="text-[#002046] font-headline font-black text-3xl sm:text-4xl mb-6 sm:mb-8">Contact Us</h2>
...
<span class="break-all text-sm sm:text-base">twinsgaragedoors@gmail.com</span>
</div>
</div>
</div>
<div class="w-full md:w-1/2 min-h-[280px] sm:min-h-[360px] md:min-h-[400px]">
<div class="h-full w-full min-h-[280px] sm:min-h-[360px] rounded-2xl sm:rounded-[2.5rem] overflow-hidden shadow-2xl border-4 sm:border-8 border-white/20">
