        ...
        <section
            ...
            <div class="absolute inset-0 z-0">
                <img alt="Professional garage door technician" class="w-full h-full object-cover"
                    src="{{ asset('images/lifting-gates-garage.jpg') }}" />
            ...
            <div
                ...
                <div class="relative">
                    ...
                    <p class="text-base sm:text-lg text-slate-200 font-light mb-8 sm:mb-10 max-w-lg">
                        Licensed, experienced, and ready to take care of any job — big or small. Twins Garage Doors LLC is
                        your trusted local expert for garage door and gate installation, repair, and service — for homes and
                        businesses of all sizes. Service area: DFW. English &amp; Spanish.
                    </p>
                    <div class="flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-4">
                        <a href="tel:+14692888881"
                ...
                <div class="hidden md:flex justify-end">
                    <div
                        ...
                        <img alt="Technician detail" class="w-full h-full object-cover rounded-2xl"
                            src="{{ asset('images/instalacion-de-puertas-automaticas.jpg.webp') }}" />
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="max-w-screen-2xl mx-auto">
                    <div class="mb-8 sm:mb-12">
                        ...
                        <div class="mt-6 max-w-2xl flex flex-col md:flex-row md:items-end gap-6">
                            <p class="text-primary font-body font-medium leading-relaxed">
                                Project photos will be featured here — residential and commercial installs and repairs
                                across DFW.
                            </p>
                    ...
                    <div
                        ...
                        <div
                            ...
                            <div>
                                <div class="text-white font-headline font-black text-4xl sm:text-5xl leading-tight">10+
                                </div>
                                <div class="text-[#87A0CD] font-headline font-bold text-xl uppercase tracking-wider">Years
                                    of experience</div>
                            </div>
                            <div>
                                <div class="text-white font-headline font-black text-4xl sm:text-5xl leading-tight">100+
                                </div>
                                <div class="text-[#87A0CD] font-headline font-bold text-xl uppercase tracking-wider">
                                    Projects completed</div>
                            </div>
                            <div>
                                <div class="text-white font-headline font-black text-4xl sm:text-5xl leading-tight">+100
                                </div>
                                <div class="text-[#87A0CD] font-headline font-bold text-xl uppercase tracking-wider">Happy
                                    customers</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
                        <div
                            ...
                            <p class="text-white/80 text-sm leading-relaxed mb-8 italic">
                                "Fast response, fair pricing, and professional work on our new garage door. Highly recommend
                                Twins Garage Doors in DFW."
                            </p>
                        ...
                        <div
                            ...
                            <p class="text-white/80 text-sm leading-relaxed mb-8 italic">
                                "They fixed our broken spring quickly and explained everything clearly. Licensed, courteous,
                                and dependable."
                            </p>
                            <div class="flex gap-1">
                                <span class="material-symbols-outlined text-yellow-400 fill-current">star</span>
                        ...
                        <div
                            ...
                            <p class="text-white/80 text-sm leading-relaxed mb-8 italic">
                                "Our automatic gate and opener upgrade was seamless. Quiet, secure, and great communication
            ...
            <div class="max-w-6xl mx-auto">
                <div class="flex flex-col md:flex-row items-stretch gap-8 md:gap-12">
                    <div class="w-full md:w-1/2 flex flex-col">
                        ...
                        <h2 class="text-[#002046] font-headline font-black text-3xl sm:text-4xl mb-6 sm:mb-8">Contact Us
                        </h2>
                        <form class="space-y-4">
                            <div class="bg-white rounded-xl p-4 shadow-sm">
                                ...
                                <input
                                    ...
                                    id="correo" placeholder="twinsgaragedoors@gmail.com" type="email" />
                            </div>
                            <div class="bg-white rounded-xl p-4 shadow-sm">
                                ...
                                <textarea class="w-full border-none p-0 focus:ring-0 text-on-surface-variant placeholder:text-slate-300 min-h-[120px]"
                                    id="mensaje" placeholder="Write your message here..."></textarea>
                            </div>
                    ...
                    <div class="w-full md:w-1/2 min-h-[280px] sm:min-h-[360px] md:min-h-[400px]">
                        <div
                            class="h-full w-full min-h-[280px] sm:min-h-[360px] rounded-2xl sm:rounded-[2.5rem] overflow-hidden shadow-2xl border-4 sm:border-8 border-white/20">
                            <iframe allowfullscreen="" height="100%" loading="lazy"
                                referrerpolicy="no-referrer-when-downgrade"
                                src="https://maps.google.com/maps?q=Dallas-Fort%20Worth%2C%20TX&amp;t=&amp;z=9&amp;ie=UTF8&amp;iwloc=&amp;output=embed"
                ...
                <div
                    class="mt-16 pt-8 border-t border-primary/10 flex flex-col md:flex-row justify-between items-center gap-6">
                    <div class="flex items-center gap-6">
                        <span class="text-primary font-bold text-sm uppercase tracking-widest">Follow us</span>
                        <div class="flex gap-4">
                            <a class="w-8 h-8 rounded-full bg-primary flex items-center justify-center text-white hover:scale-110 transition-transform"
                                href="https://www.instagram.com/TwinsGarageDoors/" target="_blank"
