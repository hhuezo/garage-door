...
<div class="bg-background font-body text-on-background">
    ...
    <section class="relative z-20 -mt-12 px-4 pb-10 sm:-mt-14 sm:px-6 md:-mt-20 md:px-8 md:pb-16 lg:-mt-24 lg:px-20">
        <div class="mx-auto max-w-6xl pr-2 pb-2 sm:pr-3 sm:pb-3 md:pr-4 md:pb-4">
            ...
            <div class="contact-page-hard-shadow mt-8 overflow-hidden rounded-md border border-outline-variant bg-surface-container-lowest p-6 md:p-8 lg:p-10">
                ...
                <form id="appointment-form" class="space-y-4 md:space-y-5" method="post" action="{{ route('contact.appointment.store') }}">
                    ...
                    <div class="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-5">
                        <div>
                            <label class="mb-1.5 block font-headline text-[10px] font-bold uppercase tracking-widest text-primary" for="appointment-date">Appointment date</label>
                            <input
                                class="w-full border-2 border-surface-container-highest px-3 py-2.5 font-body text-sm outline-none transition-all focus:border-secondary focus:ring-0 md:text-[0.9375rem]"
                                id="appointment-date"
                        ...
                        <div>
                            <label class="mb-1.5 block font-headline text-[10px] font-bold uppercase tracking-widest text-primary" for="appointment-time-slot">Available time</label>
                            <select
                                class="w-full border-2 border-surface-container-highest px-3 py-2.5 font-body text-sm outline-none transition-all focus:border-secondary focus:ring-0 md:text-[0.9375rem]"
                    ...
                    <div>
                        <label class="mb-1.5 block font-headline text-[10px] font-bold uppercase tracking-widest text-primary" for="appointment-customer-name">Full name</label>
                        <input
                            class="w-full border-2 border-surface-container-highest px-3 py-2.5 font-body text-sm outline-none transition-all focus:border-secondary focus:ring-0 md:text-[0.9375rem]"
                    ...
                    <div class="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-5">
                        <div>
                            <label class="mb-1.5 block font-headline text-[10px] font-bold uppercase tracking-widest text-primary" for="appointment-customer-phone">Phone</label>
                            <input
                                class="w-full border-2 border-surface-container-highest px-3 py-2.5 font-body text-sm outline-none transition-all focus:border-secondary focus:ring-0 md:text-[0.9375rem]"
                        ...
                        <div>
                            <label class="mb-1.5 block font-headline text-[10px] font-bold uppercase tracking-widest text-primary" for="appointment-customer-email">Email</label>
                            <input
                                class="w-full border-2 border-surface-container-highest px-3 py-2.5 font-body text-sm outline-none transition-all focus:border-secondary focus:ring-0 md:text-[0.9375rem]"
                    ...
                    <div>
                        <label class="mb-1.5 block font-headline text-[10px] font-bold uppercase tracking-widest text-primary" for="appointment-notes">Additional notes (optional)</label>
                        <textarea
                            class="w-full resize-none border-2 border-surface-container-highest px-3 py-2.5 font-body text-sm outline-none transition-all focus:border-secondary focus:ring-0 md:text-[0.9375rem]"
