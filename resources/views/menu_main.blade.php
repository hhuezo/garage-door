...
<body class="bg-surface text-on-surface font-body antialiased">
    <header class="sticky top-0 w-full z-50 nav-background shadow-lg border-b border-white/10">
        <nav class="mx-auto w-full max-w-screen-2xl px-4 py-3 sm:px-6 md:px-8 lg:px-12 xl:px-14"
            ...
            <div class="flex items-center justify-between gap-3">
                ...
                <div class="flex flex-col items-center justify-center shrink-0 min-w-0">
                    @include('partials.brand_logo', ['size' => 'sm', 'link' => true])
                </div>
                <!-- Right Links -->
                ...
                <div class="flex items-center gap-2 md:hidden shrink-0">
                    <button type="button" id="site-nav-toggle"
                        class="inline-flex h-10 w-10 items-center justify-center rounded border border-white/30 text-white hover:bg-white/10 transition-colors"
                        aria-expanded="false" aria-controls="site-mobile-menu" aria-label="Open menu">
            ...
            <div id="site-mobile-menu" class="md:hidden border-t border-white/10 mt-3 pt-3" hidden>
                <ul class="flex flex-col gap-1">
                    <li><a class="block rounded px-3 py-2.5 text-white font-headline font-bold text-sm uppercase tracking-widest hover:bg-white/10 {{ request()->is('/') ? 'bg-white/10' : '' }}"
                            href="{{ url('/') }}">Home</a></li>
                    <li><a class="block rounded px-3 py-2.5 text-white font-headline font-bold text-sm uppercase tracking-widest hover:bg-white/10 {{ request()->routeIs('services') ? 'bg-white/10' : '' }}"
                            href="{{ route('services') }}">Services</a></li>
                    <li><a class="block rounded px-3 py-2.5 text-white font-headline font-bold text-sm uppercase tracking-widest hover:bg-white/10 {{ request()->routeIs('about') ? 'bg-white/10' : '' }}"
                            href="{{ route('about') }}">About Us</a></li>
                    <li><a class="block rounded px-3 py-2.5 text-white font-headline font-bold text-sm uppercase tracking-widest hover:bg-white/10 {{ request()->routeIs('our_work') ? 'bg-white/10' : '' }}"
                            href="{{ route('our_work') }}">Our Work</a></li>
                    <li><a class="block rounded px-3 py-2.5 text-white font-headline font-bold text-sm uppercase tracking-widest hover:bg-white/10 {{ request()->routeIs('contact') ? 'bg-white/10' : '' }}"
                            href="{{ route('contact') }}">Contact Us</a></li>
                    <li><a class="block rounded px-3 py-2.5 text-white font-headline font-bold text-sm uppercase tracking-widest hover:bg-white/10 {{ request()->routeIs('reviews') ? 'bg-white/10' : '' }}"
    ...
    <footer class="w-full bg-slate-950 py-8 sm:py-12">
        <div
            class="mx-auto flex max-w-screen-2xl flex-col items-center justify-between gap-6 px-4 sm:px-6 md:flex-row lg:px-12 xl:px-14">
